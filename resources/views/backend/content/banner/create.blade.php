...
@section('content')
    {{ html()->form('POST', route('admin.banner.store'))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
            ...
            <div class="card">
                ...
                <div class="card-body p-3">
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" name="post_status" value="publish_mobile" id="publish_mobile"
                                   class="checking"
