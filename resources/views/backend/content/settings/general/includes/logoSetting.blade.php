<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <div class="form-group">
      ...
      {{html()->file('frontend_logo_menu')->class('form-control-file image
      d-none')->id('frontend_logo_menu')->acceptImage()}}
      <div class="d-block">
        <label for="frontend_logo_menu">
          <img src="{{asset(get_setting('frontend_logo_menu',$demoImg))}}" class="border img-fluid rounded holder"
            alt="Image upload">
        </label>
      </div>
    </div> <!-- form-group-->
    ...
    <div class="form-group">
      ...
      {{html()->file('frontend_logo_footer')->class('form-control-file image
      d-none')->id('frontend_logo_footer')->acceptImage()}}
      <div class="d-block">
