      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="form-group row mb-4">
            {{html()->label('Minimum Order Quantity')->class('col-md-7 col-form-label text-right')->for('min_order_quantity')}}
            <div class="col-md-5">
          ...
          <div class="form-group row mb-4">
            {{html()->label('Minimum Order Amount (BDT.)')->class('col-md-7 col-form-label text-right')->for('min_order_amount')}}
            <div class="col-md-5">
          ...
          <div class="form-group row mb-4">
            {{html()->label('China Local Delivery Charge (BDT.)')->class('col-md-7 col-form-label text-right')->for('china_local_delivery_charge')}}
            <div class="col-md-5">
          ...
          <div class="form-group row mb-4">
            {{html()->label('China Local Delivery Charge Limit (BDT.)')->class('col-md-7 col-form-label text-right')->for('china_local_delivery_charge_limit')}}
            <div class="col-md-5">
        ...
        <div class="card-body">
          ...
          <table class="table-bordered table-sm table-striped text-center">
            ...
            @forelse($shipping_charges as $key => $charges)
              <tr>
                <td>
                  {{html()->number('shipping['.$key.'][minimum]', $charges->minimum)->class('form-control form-control-sm')->attribute('min',0)->placeholder('Minimum')}}
                </td>
                <td>
                  {{html()->number('shipping['.$key.'][maximum]',$charges->maximum)->class('form-control form-control-sm')->attribute('min',0)->placeholder('Maximum')}}
                </td>
                <td>
            ...
            @empty
              <tr>
                <td>
                  {{html()->number('shipping[0][minimum]')->class('form-control form-control-sm')->attribute('min',0)->placeholder('Minimum')}}
                </td>
                <td>
                  {{html()->number('shipping[0][maximum]')->class('form-control form-control-sm')->attribute('min',0)->placeholder('Maximum')}}
                </td>
                <td>
                  {{html()->number('shipping[0][rate]')->class('form-control form-control-sm')->attribute('min',0)->placeholder('Rate')}}
                </td>
                <td>
                  <button type="button" class="btn btn-sm btn-danger removeField">Remove</button>
                </td>
