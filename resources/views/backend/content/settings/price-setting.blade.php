            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-md-8">
                            {{ html()->text('base_currency', get_setting('base_currency'))->class('form-control')->attribute('aria-describedby', 'baseCurrency') }}
                    ...
                    {{-- FOR SUB API DOMAINS --}}
                    <div class="form-group row mb-4">
                        {{ html()->label('Addidional Charge (%)')->class('col-md-4 col-form-label text-right')->for('additional_charge') }}
                        <div class="col-md-8">
                            {{ html()->text('additional_charge')->class('form-control')->value(get_setting('additional_charge'))->placeholder('8%')->attribute('aria-describedby', 'additional_charge') }}
                            <small id="additional_charge" class="form-text text-muted">Example: &nbsp; This rate will
                                multiple the cny price</small>
                        </div> <!-- col-->
                    </div> <!-- form-group-->
                    {{-- FOR SUB API DOMAINS --}}
