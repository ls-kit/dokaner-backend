...
@section('title', 'Products Customer Loving')
    ...
    <div class="row align-items-center">
      <div class="col-md-6">
        <div class="page-title">
          <h1>@lang('Products Customer Loving')</h1>
        </div>
      </div>
      <div class="col-md-6">
        <ol class="breadcrumb justify-content-md-end">
          <li class="breadcrumb-item"><a href="{{route('frontend.index')}}">Home</a></li>
          <li class="breadcrumb-item active">@lang('Products Customer Loving')</li>
        </ol>
      </div>
    </div>
  </div> <!-- END CONTAINER-->
...
<div class="main_content">
  <div class="section" style="padding-bottom: 50px">
    <div class="container">
      <div class="row">
        @forelse($customerLoving as $item)
      ...
      <div class="row">
        <div class="col-12">
          {{$customerLoving->onEachSide(1)->render()}}
        </div>
      </div> <!-- row -->
