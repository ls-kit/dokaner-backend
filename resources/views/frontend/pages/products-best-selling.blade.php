...
@section('title', 'Products Best Selling')
    ...
    <div class="row align-items-center">
      <div class="col-md-6">
        <div class="page-title">
          <h1>@lang('Products Best Selling')</h1>
        </div>
      </div>
      <div class="col-md-6">
        <ol class="breadcrumb justify-content-md-end">
          <li class="breadcrumb-item"><a href="{{route('frontend.index')}}">Home</a></li>
          <li class="breadcrumb-item active">@lang('Products Best Selling')</li>
        </ol>
      </div>
    </div>
  </div> <!-- END CONTAINER-->
...
<div class="main_content">
  <div class="section" style="padding-bottom: 50px">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          {{$bestSelling->onEachSide(1)->render()}}
        </div>
      </div> <!-- row -->
